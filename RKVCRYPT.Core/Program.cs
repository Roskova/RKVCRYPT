            ...
            */
            ...
            while (true)
            {
                ...
                switch (select)
                {
                    ...
                    case "5": Console.WriteLine("Entrez la nouvelle clé de chiffrement"); key = Console.ReadLine(); break;
                    case "6": Console.WriteLine("Veuillez entrez le nouveau message"); message = Console.ReadLine(); break;
                }
            }
